...
import static ru.duckest.utils.test.dto.QuestionDtoTestFactory.getQuestionWithThreeAnswersAndFirstRight;
import static ru.duckest.utils.test.dto.TestDtoTestFactory.getDummyTestDto;
import static ru.duckest.utils.test.jpa.QuizDescriptionTestFactory.getDummyQuizDescription;
import static ru.duckest.utils.test.jpa.QuizLevelTypePairTestFactory.getDummyTestEntity;
import static ru.duckest.utils.test.jpa.QuizQuestionTestFactory.getDummyQuizQuestion;
import static ru.duckest.utils.test.jpa.QuizQuestionTestFactory.getTwentyDummyQuestions;
